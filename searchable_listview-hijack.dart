...
class SearchableList<T> extends StatefulWidget {
  ...
  SearchableList({
    ...
    this.defaultSuffixIconColor = Colors.black, //changed from grey to black
    this.onRefresh,
    this.scrollDirection = Axis.vertical,
    this.searchTextPosition = SearchTextPosition.top,
    this.onPaginate,
    this.spaceBetweenSearchAndList = 20,
    this.cursorColor = Colors.black, //added = Color.black
    this.maxLines,
    this.maxLength,
    this.textAlign = TextAlign.start,
    this.autoCompleteHints = const [],
    this.autoFocusOnSearch = false, //changed from true to false
  }) : super(key: key) {
